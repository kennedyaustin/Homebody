...
import { Card, Tab, TabContainer, Row, Col, Nav, TabContent, TabPane } from "react-bootstrap";
import dayjs from 'dayjs'
import SavedWorkoutCard from "../SavedWorkoutCard/SavedWorkoutCard";

function SavedWorkoutTab({ id, date, exercises }) {
  return (
    <>   
...
export default SavedWorkoutTab;
